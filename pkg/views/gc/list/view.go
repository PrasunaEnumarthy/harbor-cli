...
// ListGCExecutions renders the garbage collection history in a terminal table
func ListGCExecutions(executions []*models.GCHistory) {
	var rows []table.Row
	for _, exec := range executions {
		createdTime, _ := utils.FormatCreatedTime(exec.CreationTime.String())
